        ...
        return (
            <div className="flex flex-1 flex-col min-h-full px-8 py-4 justify-center space-y-5">
                ...
                <div className="flex items-center grow space-x-2 w-full min-h-[12vh] md:min-h-[20vh] overflow-x-auto">
                    <Link href='/extrato' className="flex-1 w-full min-w-[30%] sm:min-w-0 py-2 md:py-4 md:px-8 text-center text-md sm:text-xl hover:bg-gray-200 border-2 rounded-lg border-solid hover:border-gray-200 border-gray-50 shadow-md">
                        <FontAwesomeIcon icon={faMoneyBillTransfer} /><p>Extrato</p>
                    </Link>
                    <Link href='/depositar' className="flex-1 w-full min-w-[30%] sm:min-w-0 py-2 md:py-4 md:px-8 text-center text-md sm:text-xl hover:bg-gray-200 border-2 rounded-lg border-solid hover:border-gray-200 border-gray-50 shadow-md">
                        <FontAwesomeIcon icon={faMoneyBillTransfer} /><p>Depositar</p>
                    </Link>
                    <Link href='/sacar' className="flex-1 w-full min-w-[30%] sm:min-w-0 py-2 md:py-4 md:px-8 text-center text-md sm:text-xl hover:bg-gray-200 border-2 rounded-lg border-solid hover:border-gray-200 border-gray-50 shadow-md">
